...
src_img = Image.open("/home/pranav/bageljax/samples/stacked_droid.png")
src_img_np = np.array(src_img)
src_img_np = src_img_np[:, :, :-1]
assert src_img_np.shape == (672, 560, 3), f"Got shape {src_img_np.shape}"
...
ae_checkpoint_path = "/home/pranav/bageljax/pretrained_weights/ae"
...
assert img_encoded.shape == (1, 84, 70, 16) and img_encoded.dtype == jnp.float32
...
recon.save("/home/pranav/bageljax/samples/recon.png")